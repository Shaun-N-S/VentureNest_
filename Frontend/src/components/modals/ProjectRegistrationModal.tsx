...
const verifyStartupSchema = z.object({
  gstCertificate: z
    .instanceof(File, { message: "Please upload a GST certificate" })
  ...
  companyRegistrationCertificate: z
    .instanceof(File, { message: "Please upload a company certificate" })
    .refine((f) => f.size <= 5_000_000, "Max size 5MB")
    .refine(
      (f) =>
        ["image/jpeg", "image/jpg", "image/png", "application/pdf"].includes(
...
export function VerifyStartupModal({
  open,
  onOpenChange,
  projectId,
  founderId,
  ...
  const handleFileSelect = (
    ...
    field: "gstCertificate" | "companyRegistrationCertificate",
  ) => {
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border-2 border-dashed rounded-xl h-44 flex flex-col items-center justify-center bg-muted/20 cursor-pointer hover:bg-muted/40 transition relative overflow-hidden">
                          ...
                          <input
                            ...
                            className="absolute inset-0 opacity-0 cursor-pointer"
                            onChange={(e) =>
                              handleFileSelect(e, "gstCertificate")
                            }
                          />
                        </div>
                        {error && (
