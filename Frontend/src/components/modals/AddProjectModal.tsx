...
export default function AddProjectModal({ open, onOpenChange, onSubmit, isEditing = false }: AddProjectModalProps) {
    ...
    const handleFileChange = (
        ...
        if (file) {
            ...
            if ((fieldName === "logo" || fieldName === "coverImage") && file.size > 5 * 1024 * 1024) {
            ...
            if (setPreview && (fieldName === "logo" || fieldName === "coverImage")) {
                                ...
                                <div>
                                    ...
                                    <label className="flex flex-col items-center justify-center w-full p-6 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-gray-400 transition bg-gray-50">
                                        ...
                                        <input
                                            type="file"
                                            accept="image/*"
                                            onChange={(e) => handleFileChange(e, "coverImage", setCoverPreview)}
                                            className="hidden"
                                        />
                                    </label>
                                    {error && <p className="text-red-500 text-xs mt-1">{error.message}</p>}
