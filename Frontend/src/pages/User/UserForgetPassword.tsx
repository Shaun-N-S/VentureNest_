...
import { useForgetPasswordResetPassword, useForgetPasswordVerifyOtp, useUserForgetPassword } from "../../hooks/AuthHooks"
...
const ForgotPasswordPage = () => {
  ...
  const handleResetPassword = async () => {
    forgetPasswordResetPassword({ email, token, newPassword }, {
      onSuccess: (res) => {
