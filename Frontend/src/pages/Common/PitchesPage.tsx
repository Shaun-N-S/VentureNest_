    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      <div className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 py-6 xs:py-8 sm:py-12">
        ...
        >
          ...
          {/* Enhanced Stats Grid */}
          {/* <motion.div
            className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 xs:gap-3 sm:gap-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          {/* Investment Summary (if has accepted offers) */}
          {/* {totalInvestment > 0 && (
            <motion.div
              className="mt-3 xs:mt-4 p-4 xs:p-5 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg"
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs xs:text-sm font-medium text-green-700">
                    Total Funding Secured
                  </p>
                  <p className="text-xl xs:text-2xl font-bold text-green-900 mt-1">
                    ${(totalInvestment / 1000000).toFixed(1)}M
                  </p>
                </div>
                <TrendingUp className="w-6 xs:w-8 h-6 xs:h-8 text-green-600 opacity-20 flex-shrink-0" />
              </div>
            </motion.div>
          )}*/}
        </motion.div>
...
//   return (
//     <div
//       className={`p-4 border rounded-lg ${color} transition-all hover:shadow-md`}
//     >
