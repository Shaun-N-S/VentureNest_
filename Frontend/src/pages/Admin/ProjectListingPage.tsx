  ...
  const headers = useMemo(
    () => [
      ...
      },
      {
        id: "sector",
        label: "Sector",
        render: (row: TableProject) => row.category ?? "N/A",
      },
      {
        id: "stage",
        label: "Stage",
    ...
    <div className="bg-white p-6 rounded-xl shadow-md">
      ...
      <div className="flex flex-col md:flex-row gap-3 md:items-center md:justify-between mb-6">
        ...
        <select
          ...
          className="px-4 py-2 border w-45 border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400"
        >
