...
import {
  useInvestorGoogleLoginMutation,
  useInvestorLogin,
      ...
      onSuccess: (res) => {
        ...
        dispatch(
          setData({
            ...
            bio: res.data.investor.bio || "",
            website: res.data.investor.website || "",
            linkedInUrl: res.data.investor.linkedInUrl || "",
            companyName: res.data.investor.companyName || "",
            adminVerified: res.data.investor.adminVerified || false,
          }),
        );
